...
- **`/crime` (Crime & Safety Domain)** *(Phase 15, planned)*: NCRB crime data — IPC crimes, crimes against women, road accidents, cybercrime, police infrastructure, conviction rates. Sub-routes: `/crime/explore`, `/crime/methodology`, `/crime/glossary`. Source: NCRB "Crime in India" + data.gov.in NCRB API + MoRTH + World Bank.
