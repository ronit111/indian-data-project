        ...
        "terms": [
            {
                ...
                "detail": "LFPR measures economic engagement. India's LFPR (60.1% usual status, 55.8% CWS) has risen sharply from 49.8% in 2017-18. Male LFPR (~79%) is comparable to global norms, but female LFPR (~42% usual status) remains below the global average. PLFS uses 'Usual Status' (principal + subsidiary activity in the past year) for annual estimates and 'Current Weekly Status' (CWS) for quarterly estimates.",
                "inContext": "India LFPR: 60.1% (PLFS 2023-24 usual status). Male: 78.8%, Female: 41.7%.",
            ...
            },
            {
                ...
                "detail": "Unemployment rate = unemployed / labour force × 100. India's headline unemployment (3.2% usual status, ~5% CWS) looks low by global standards, but it masks underemployment (people working fewer hours than they want) and disguised unemployment (people in agriculture with near-zero productivity). Youth unemployment is 3x the overall rate. Measurement matters: PLFS quarterly CWS shows higher unemployment than annual usual status because it captures short-term joblessness.",
                "inContext": "India UR: 3.2% (PLFS 2023-24 usual status). Youth (15-29): 10.2%. Rural: 2.5%, Urban: 5.1%.",
            ...
            },
            {
                ...
                "inContext": "India WPR: 58.2% (PLFS 2023-24 usual status). Male: 76.3%, Female: 40.3%.",
            ...
            },
            {
                ...
                "detail": "Over 58% of India's workforce is self-employed (PLFS 2023-24). Self-employment is highest in agriculture (nearly all farmers are self-employed) and retail trade. The category includes own-account workers (running their own micro-enterprise) and unpaid family helpers (often women working on family farms or shops). High self-employment is a marker of informal, subsistence economies — it falls as countries industrialize.",
                "inContext": "58.4% self-employed (PLFS 2023-24 usual status). Bihar: 68%, Delhi: 28%.",
