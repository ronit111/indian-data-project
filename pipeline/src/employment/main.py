...
def run_employment_pipeline():
    ...
    plfs_api_states = fetch_state_employment(year="2025")
    plfs_api_nationals = fetch_national_totals(year="2025")
    ...
    publish_provenance("employment", SURVEY_YEAR)
        ...
        "terms": [
            {
                ...
                "detail": "LFPR measures economic engagement. India's LFPR (59.3% usual status, 55.8% CWS) has risen sharply from 49.8% in 2017-18. Male LFPR (~79%) is comparable to global norms, but female LFPR (~40% usual status) remains below the global average. PLFS uses 'Usual Status' (principal + subsidiary activity in the past year) for annual estimates and 'Current Weekly Status' (CWS) for quarterly estimates.",
                "inContext": "India LFPR: 59.3% (PLFS 2025 usual status). Male: 79.1%, Female: 40.0%.",
            ...
            },
            {
                ...
                "detail": "Unemployment rate = unemployed / labour force × 100. India's headline unemployment (3.1% usual status, ~5% CWS) looks low by global standards, but it masks underemployment (people working fewer hours than they want) and disguised unemployment (people in agriculture with near-zero productivity). Youth unemployment is 3x the overall rate. Measurement matters: PLFS quarterly CWS shows higher unemployment than annual usual status because it captures short-term joblessness.",
                "inContext": "India UR: 3.1% (PLFS 2025 usual status). Youth (15-29): 9.9%. Rural: 2.4%, Urban: 4.8%.",
            ...
            },
            {
                ...
                "detail": "India has ~60 crore people under 25 — the world's largest youth population. Youth unemployment at ~9.9% means roughly 1.5 crore young people are actively seeking work but can't find it. The paradox: educated youth face higher unemployment than uneducated youth (graduates: ~13% vs illiterates: ~2%), because educated youth have higher job expectations and can afford to wait. This is the 'educated unemployment' problem.",
                "inContext": "Youth UR (15-29): 9.9% (PLFS 2025 usual status). Graduates: ~13%. School dropouts: ~3%.",
            ...
            },
            {
                ...
                "detail": "Over 56% of India's workforce is self-employed (PLFS 2025). Self-employment is highest in agriculture (nearly all farmers are self-employed) and retail trade. The category includes own-account workers (running their own micro-enterprise) and unpaid family helpers (often women working on family farms or shops). High self-employment is a marker of informal, subsistence economies — it falls as countries industrialize.",
                "inContext": "56.2% self-employed (PLFS 2025 usual status). Bihar: 65%, Delhi: 39%.",
            ...
            },
            {
                ...
                "detail": "In 1991, agriculture employed 65% of Indians. Today it's ~43% — but it still produces only ~17% of GVA. This means agricultural productivity is far below manufacturing or services. The 'transformation' is workers moving to higher-productivity sectors. India's unique pattern: workers are moving directly from agriculture to services (skipping manufacturing). This 'premature de-industrialization' worries economists because manufacturing historically creates more stable, higher-paying jobs.",
            ...
            },
            {
                ...
                "detail": "India's female LFPR (~40% usual status, ~35% CWS) has risen sharply from 23% in 2017-18 but remains below Bangladesh (38%) and far below China (62%). The U-shaped hypothesis says female LFPR falls as families get richer (women leave farm work) and rises again at higher incomes (women enter professional jobs). India appears to be climbing out of the dip. Contributing factors for the historically low rate: safety concerns, social norms, care responsibilities, and lack of suitable local jobs.",
                "inContext": "India female LFPR: 40.0% (PLFS 2025 usual status). China: 62%. Bangladesh: 38%. Global: 47%.",
                "relatedTerms": ["lfpr", "unemployment-rate"],
            },
            {
                "id": "gig-economy",
