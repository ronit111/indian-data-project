  ...
  return (
    <section ref={ref} id="growth" className="composition" style={{ background: 'var(--bg-surface)' }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          Real GDP growth (adjusted for inflation) tells you how much more the economy produced — more goods, more services, more jobs. India has averaged around 7% growth in the recovery years. But per-capita GDP grew slower because of population growth, and most gains concentrated in services. From the 8% pre-pandemic peak through the -5.8% COVID collapse to the recovery, here is the headline number — and what it leaves unsaid.
        </motion.p>
