  ...
  return (
    <section ref={ref} id="outlook" className="composition" style={{ background: 'var(--bg-surface)' }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          Growth is projected to stay fast by global standards. But the question isn't whether India grows. It's whether growth reaches the 60% of Indians in rural areas, the ~43% still in agriculture, and the young people entering the workforce at 1.2 crore a year. These are the four numbers that set the challenge.
        </motion.p>
