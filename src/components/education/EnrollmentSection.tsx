  ...
  return (
    <section ref={ref} id="enrollment" className="composition" style={{ background: 'var(--bg-surface)' }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          India's primary Gross Enrollment Ratio (GER) has crossed 100% — a sign of near-universal access. (GER can exceed 100% when over-age or under-age students enroll.) Getting nearly every child into a classroom in a country this large and this poor is a genuine civilizational achievement. The revolution is real: secondary enrollment nearly tripled in two decades, tertiary enrollment climbed from 10% to nearly 30%. Let the triumph land before asking what happens next.
        </motion.p>
