  ...
  return (
    <section ref={ref} id="carbon-footprint" className="composition">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          India emits about 1.9 tonnes of CO₂ (carbon dioxide) per person per year — well below the US (14) and China (8), as of 2022. But with 1.4 billion people, the total ranks 3rd globally. India needs energy to develop, yet is among the most climate-vulnerable nations.
        </motion.p>
