  ...
  return (
    <section ref={ref} id="forest-cover" className="composition">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          India has 21.76% forest cover — 25.17% counting tree cover outside forests — according to ISFR 2023 (India State of Forest Report), below the 33% national policy target. Madhya Pradesh leads losses (-372 km²), followed by Andhra Pradesh and Telangana. Mizoram, Gujarat, and Odisha saw the largest gains.
        </motion.p>
