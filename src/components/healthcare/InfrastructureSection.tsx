  ...
  return (
    <section ref={ref} id="infrastructure" className="composition" style={{ background: 'var(--bg-surface)' }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          India has about 1.6 hospital beds per 1,000 people (public and private combined, World Bank 2021; 0.5 in government hospitals). The WHO recommends 3.5 — we are not even halfway there.
        </motion.p>
