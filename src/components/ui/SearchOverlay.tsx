...
export function SearchOverlay() {
  ...
  const searchItems = useMemo(() => {
    ...
    items.push(
      ...
      { type: 'page', id: 'topic-regional', name: 'Regional Inequality', subtitle: 'Income divide, city-village gap, education & health disparities, fiscal transfers', route: '/topics/regional-inequality' },
      ...
      { type: 'page', id: 'topic-democracy', name: "India's Democratic Health", subtitle: 'Participation arc, quality of representation, accountability', route: '/topics/democratic-health' },
      ...
      { type: 'page', id: 'states', name: 'State Finances', subtitle: 'State GDP, revenue, and fiscal health', route: '/states' },
