...
export const HEALTH_INFRASTRUCTURE: StoryKitDef = {
  ...
  charts: [
    ...
    },
    {
      ...
      caption: 'Out-of-pocket expenditure: the hidden tax on illness. Indians pay ~45% of health costs from their own pockets — one of the highest rates globally.',
    },
    {
  ...
  suggestedAngles: [
    "The doctor deficit: India has 0.7 allopathic doctors per 1,000 people (WHO norm: 1), and they're concentrated in cities. What does healthcare look like in rural India?",
